...
set AREA_RPT $REP_DIR/barrelShifter_area.rpt
set TIME_RPT $REP_DIR/barrelShifter_time.rpt
set POWER_RPT $REP_DIR/barrelShifter_power.rpt

set top_mdl barrelShifter
define_design_lib WORK -path "./work"

# Small loop to read in several files
#set all_files {../src/rtl/barrelShifter.sv}
pwd
set all_files {../../src/rtl/barrelShifter.sv}
