...
set AREA_RPT $REP_DIR/combShifter_area.rpt
set TIME_RPT $REP_DIR/combShifter_time.rpt
set POWER_RPT $REP_DIR/combShifter_power.rpt

set top_mdl combShifter
define_design_lib WORK -path "./work"

# Small loop to read in several files
#set all_files {../src/rtl/combShifter.sv}
pwd
set all_files {../../src/rtl/combShifter.sv}
