...
# DVE full session
# Saved on Mon Apr 11 16:08:10 2022
# Designs open: 1
...
#<Session mode="Full" path="/afs/andrew.cmu.edu/usr13/aeega/private/18743/743_final_proj/DVEfiles//crash_04.11-16.08/dve_session04.11-16.08.tcl" type="Debug">
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 130} {height 877} {dock_state left} {dock_on_new_line true} {child_hier_colhier 132} {child_hier_coltype 10} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 257} {height 877} {dock_state left} {dock_on_new_line true} {child_data_colvariable 170} {child_data_colvalue 12} {child_data_coltype 74} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 291} {child_wave_right 1106} {child_wave_colname 287} {child_wave_colvalue 0} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_wv_zoom_timerange -id ${Wave.1} 0 362
